...
{
    public static class AocChallenge
    {
        public static void binaryDiagnostic(string[] bin)
        {
        ...
        public static void submarineMovement(string[] mov)
        {
            int forward = 0;
            int depth = 0;
            int aim = 0;
        ...
        public static void depthCount(string[] depth)
        {
            /*  Test input
                199
                200
